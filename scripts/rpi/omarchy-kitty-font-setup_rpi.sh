...
echo "Step 1: Installing kitty and fonts-codenewroman-nerd-font..."
read -p "Run 'pkg_install kitty fonts-codenewroman-nerd-font && fc-cache -fv'? (y/n): " -n 1 -r
echo
if [[ $REPLY =~ ^[Yy]$ ]]; then
    # omarchy-install-terminal kitty
    pkg_install kitty fonts-codenewroman-nerd-font
    fc-cache -fv
    echo "✓ Installed!"
else
