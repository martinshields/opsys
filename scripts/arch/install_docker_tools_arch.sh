#!/bin/bash
# Check and install Docker, Docker Compose, and LazyDocker on Arch Linux ARM
...
install_docker_compose() {
  ...
  if sudo pacman -Si docker-compose >/dev/null 2>&1; then
...
echo "🔍 Checking installations on Arch Linux ARM..."
